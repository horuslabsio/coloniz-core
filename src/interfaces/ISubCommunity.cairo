...
pub trait ISubCommunity<TState> {
    ...
    fn set_sub_community_metadata_uri(
        ref self: TState, sub_community_id: u256, metadata_uri: ByteArray
    );
    fn set_channel_metadata_uri(ref self: TState, channel_id: u256, metadata_uri: ByteArray);
    fn add_sub_community_mods(
        ref self: TState, sub_community_id: u256, moderators: Array<ContractAddress>
    );
    ...
    fn is_sub_community_mod(
        self: @TState, profile: ContractAddress, sub_community_id: u256
    ) -> bool;
